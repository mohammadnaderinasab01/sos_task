...
class InsuredDataView(APIView):
    ...
    @extend_schema(
        ...
        description='Process insured data with insurer-specific field mappings based on case-insensitive insurer name. '
                    'Defaults to model-aligned fields for unmatched insurer names.',
        examples=[
            OpenApiExample(
                'Default Example',
                value={
                ...
                description='Valid payload for default service (unmatched insurer name, e.g., "generic"; uses model fields, email optional).'
            ),
            OpenApiExample(
                'Pasargad Example',
                value={
                ...
                description='Valid payload for Pasargad (insurer name: "pasargad" case-insensitive, email required).'
            ),
            OpenApiExample(
                'Hekmat Example',
                value={
